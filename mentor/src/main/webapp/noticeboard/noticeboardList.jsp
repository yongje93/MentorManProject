...
<div class="page navbar-fixed mentee_programs index">
	<div class="page-content">
		<form id="noticeboardSearch" method="post">
			...
			<div id="searchImage_div" style="float: right;">
				<img id="search_image" src="../image/images.png" style="width: 20px; height: 20px; cursor: pointer;">
			</div>
			<div id="searchText_div" style="float: right;">
				<input type="text" name="searchText" id="searchText" placeholder="찾기" value="${searchText}" style="width: 200px;">
			</div>
			<input type="hidden" name="pg" value="1">
			<div id="searchText_error_div"></div>
		</form>
		<div id="boardList_div">
			<form id="noticeboardWriteForm" name="noticeboardWriteForm"
				method="post" action="/mentor/noticeboard/noticeboardDelete">
