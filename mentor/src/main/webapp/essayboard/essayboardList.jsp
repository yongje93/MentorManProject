...
<div class="page navbar-fixed open_mentorings index" data-name="open_mentorings-index">
  <div class="page-content">
    <div class="block job-type-block">
      ...
      <div class="row">
          <a class="button color-gray " id="job1" type="external" href="/mentor/essayboard/essayjobType?jobType=job_code_0">인사/총무/노무</a>
...
<div class="col-100 tablet-50 desktop-33">
  ...
  <div class="card-header">
    <a class="color-black" type="external" href="/mentor/essayboard/essaymentorHeadView?seq=${list.essayboard_seq }&pg=${pg}&name=${list.member_name }">
      <!-- - ---------------------- -->
      <div>
  ...
  <div class="card-content card-content-padding"style="overflow: hidden; text-overflow: ellipsis; height: 200px; ">
   <a class="text-decoration-underline" type="external" href="/mentor/essayboard/essayjobType?jobType=${list.job_code }">
    ...
    <a class="content-body" type="external" href="/mentor/essayboard/essaymentorBodyView?seq=${list.essayboard_seq }&pg=${pg}&name=${list.member_name }">
